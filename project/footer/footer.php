     ...
     <div class="container">
      <div class="row">
        ...
        <div class="footer-col">
          <h4>Contact us</h4>
            <ul>
            <li><i class="fas fa-map-marker-alt"></i>Đại học bách khoa Hà Nội</li>
            <li><i class="fas fa-phone-alt"></i>+089-1005200156</li>
            <li><i class="fas fa-envelope"></i>hanoifoods@gmail.com</li>
            </ul>
          </div>
      </div>
     </div>
