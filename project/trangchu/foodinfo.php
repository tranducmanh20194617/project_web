            ...
            <div class = "food-item do_an">
              ...
              <div class = "food-content">
                ...
                <h3 class = "food-price"><?php echo $row_1['price'] . " đồng"; ?></h3>
                 ...
                 <a href=" <?php echo '/project/restaurant/restaurant.php?stall='.$row_1['id_stall'] ?>" class="chi_tiet">Chi tiết</a>
...
<?php } ?>
           ...
           <?php while($row_3 = pg_fetch_array($showdobanhngot)){ ?>
            ...
            <div class = "food-item banh_kem">
              ...
              <a href=" <?php echo '/project/restaurant/restaurant.php?stall='.$row_3['id_stall'] ?>" class="chi_tiet">Chi tiết</a>
...
<?php } ?>
           ...
           <?php while($row_4 = pg_fetch_array($showanvat)){ ?>
            ...
            <div class = "food-item an_vat">
              ...
              <a href=" <?php echo '/project/restaurant/restaurant.php?stall='.$row_4['id_stall'] ?>" class="chi_tiet">Chi tiết</a>
...
<?php } ?>
           ...
           <?php while($row_7 = pg_fetch_array($showdouong)){ ?>
            ...
            <div class = "food-item do_uong">
              ...
              <a href=" <?php echo '/project/restaurant/restaurant.php?stall='.$row_7['id_stall'] ?>" class="chi_tiet">Chi tiết</a>
...
<?php } ?>
           ...
           <?php while($row_8 = pg_fetch_array($showdotrangmieng)){ ?>
            ...
            <div class = "food-item do_trang_mieng">
              ...
              <a href=" <?php echo '/project/restaurant/restaurant.php?stall='.$row_8['id_stall'] ?>" class="chi_tiet">Chi tiết</a>
